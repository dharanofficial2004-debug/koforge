          ...
          <div>
            ...
            <form className="space-y-6">
              <div>
                ...
                <input type="text" id="name" name="name" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-purple focus:ring-brand-purple sm:text-sm p-3 border" required />
              </div>
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email or Phone</label>
                <input type="text" id="email" name="email" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-purple focus:ring-brand-purple sm:text-sm p-3 border" required />
              </div>
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-gray-700">Message</label>
                <textarea id="message" name="message" rows={4} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-purple focus:ring-brand-purple sm:text-sm p-3 border" required></textarea>
              </div>
          ...
          <div>
            ...
            <div className="space-y-6 mb-10">
              <div className="flex items-start">
                <svg className="h-6 w-6 text-brand-purple mr-4 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:koforge.official@gmail.com" className="text-brand-purple hover:underline">koforge.official@gmail.com</a>
                </div>
              </div>
              <div className="flex items-start">
                <svg className="h-6 w-6 text-brand-purple mr-4 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                  ...
                  <a href="tel:+918838235891" className="text-brand-purple hover:underline">+91 88382 35891</a>
                </div>
              </div>
            </div>
